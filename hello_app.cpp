...
void HelloTriangleApplication::recordCommandBuffer(VkRenderPass& renderPass, VkCommandBuffer commandBuffer, uint32_t imageIndex)
{
...
void HelloTriangleApplication::createInstance() {
	...
	appInfo.pApplicationName = "Hello Shadow Map";
...
void HelloTriangleApplication::drawFrame()
{
	...
	recordCommandBuffer(renderPass, commandBuffers[currentFrame], imageIndex);
